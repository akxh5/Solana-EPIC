...
echo "Publishing @solana-epic/cli-darwin-arm64..."
cd packages/cli-darwin-arm64
npm publish --access public --tag beta
cd ../..

echo "Publishing @solana-epic/cli-darwin-x64..."
cd packages/cli-darwin-x64
npm publish --access public --tag beta
cd ../..

echo "Publishing @solana-epic/cli-linux-x64..."
cd packages/cli-linux-x64
npm publish --access public --tag beta
cd ../..

echo "Publishing @solana-epic/cli-win32-x64..."
cd packages/cli-win32-x64
npm publish --access public --tag beta
cd ../..

# 2. Publish shared libraries
echo "Publishing @solana-epic/parser..."
cd packages/parser
npm publish --access public --tag beta
cd ../..

echo "Publishing @solana-epic/diff-engine..."
cd packages/diff-engine
npm publish --access public --tag beta
cd ../..

# 3. Publish CLI binary loader
echo "Publishing @solana-epic/cli..."
cd packages/cli
npm publish --access public --tag beta
cd ../..

# 4. Publish GitHub Action integration
echo "Publishing @solana-epic/github-action..."
